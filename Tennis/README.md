...
In this project, MADDPG(Multi Agent Deep Deterministic Policy Gradient) agent was implemented to control rackets in Unity's  [Tennis](https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Learning-Environment-Examples.md#tennis) environment.

<p align="center">
  <img src="docs/images/trained_agent.gif" height="300px">
</p>
...
3. Place the file in the cloned reinforcement-learning repository's' `Tennis/` folder, and unzip (or decompress) the file.
