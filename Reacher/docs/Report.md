...
In this project, DDPG agent was implemented to navigate and collect bananas in a Unity's [Reacher](https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Learning-Environment-Examples.md#banana-collector) world.  
